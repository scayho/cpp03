...
/*   Updated: 2023/02/06 14:32:17 by abelahce         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
    std::cout << " default constructor of ClapTrap has ben called !" << std::endl;
    this->name = "nameless";
    this->Hit_Points = 10;
...
{
    std::cout << " default deconstructor of ClapTrap has ben called !" << std::endl;
}

ClapTrap::ClapTrap(std::string name)
{
    std::cout << "  constructor of ClapTrap has ben called !" << std::endl;
    this->name = name;
    this->Hit_Points = 10;
    this->Energy_Points = 10;
    this->Attack_Damage = 0;
...
{
    std::cout << " copy from itself of ClapTrap constructor has ben called !" << std::endl;
